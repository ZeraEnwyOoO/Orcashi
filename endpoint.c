...
// ===== HELPER: Normalize ID (remove < and >) =====
...
static void parse_message(Discovery* disc, const char* msg, const char* sender_ip, int sender_port) {
    ...
    // ===== HANDLE WHO_HAS (Active Query) - FIXED with normalize! =====
...
// ===== FIND PEER - FIXED with normalize! =====
